...
public class UpcomingEventFragment extends Fragment {
    ...
    private List<ParseObject> nonLiveEvents = new ArrayList<>();
        ...
        if (eventList != null) {
            if (eventList.size() > 0) {
                for (int i = 0; i < eventList.size(); i++) {
                    ...
                    if (DateVerifier.goLive(startTime, endTime).getReason() == LiveStatus.EVENT_NOT_STARTED) {
                ...
                new RecyclerItemClickListener(
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                OpenEventConversation.openConversation(nonLiveEvents.get(position), applicationContext);
                            }
                            ...
                            public void onItemLongClick(View view, int position) {
                                ...
                                OpenEventConversation.openEventInfo(nonLiveEvents.get(position), applicationContext);
                            }
                        }));
    }
